...
namespace WordDocumentParser
{
    ...
    public class RunFormatting
    {
        ...
        public bool HasFormatting =>
            ...
            Highlight != null || Superscript || Subscript || SmallCaps || AllCaps;
    ...
    public class FormattedRun
    {
        ...
        public RunFormatting Formatting { get; set; } = new RunFormatting();
        ...
        public FormattedRun(string text, RunFormatting formatting)
        {
            Text = text;
    ...
    public class ParagraphFormatting
    {
        ...
        public bool HasFormatting =>
            StyleId != null || Alignment != null ||
            IndentLeft != null || IndentRight != null ||
            IndentFirstLine != null || IndentHanging != null ||
            SpacingBefore != null || SpacingAfter != null ||
            LineSpacing != null || KeepNext || KeepLines ||
            PageBreakBefore || ShadingFill != null;
    ...
    public class TableFormatting
    {
        ...
        public TableFormatting Clone()
        {
            return new TableFormatting
            {
                ...
                GridColumnWidths = GridColumnWidths != null ? new List<string>(GridColumnWidths) : null
            };
        }
    }
    ...
    public class TableCellFormatting
    {
        ...
        {
            return new TableCellFormatting
            {
                Width = Width,
                WidthType = WidthType,
                GridSpan = GridSpan,
